...
def alter_list(a_list, list_integers):
    i = 0
    for indice_word in a_list:
        if indice_word == list_intergers[i]:
            if a_list[list_interger[indice_word]].islower:
                a_list[list_interger[indice_word]].upper()
                i += 1
            else:
                a_list[list_interger[indice_word]].lower()
                i += 1
    return a_list
