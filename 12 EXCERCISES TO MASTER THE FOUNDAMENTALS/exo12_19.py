...
def lazy_encrypt(string1, string2, a_dict):
    # string1 file name of a file for output
    # string2 filename of a file to read input
    # a_dict mapping of character
    
    # open to read the file string1
    
    
    
    # open to write in file string2
    
    
    # search algorithm and amendments
    
    for each_char in string2:
        for k,v in a_dict:
            if each_char == v:
                each_char = v
            else:
