...
#Write your function here!
    ...
    def check_availability(self, list_meetings, proposed_time):
        for instance_time in list_meetings:
            start_time = meetings[0]
            end_time = meetings[1]
            if start_time < proposed_time and proposed_time < end_time:
                return False
            else:
                return True
