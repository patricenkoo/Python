...
def to_dictionaries(nations_list):
    result_dict = {}
    for nations in nations_list:
        result_dict[nations.short_name] = {"long_name": nations.long_name, "iso_code": nations.iso_code, "iso_short": nations.iso_short, "iso_long": nations.iso_long, "capital": nations.capital}
    return result_dict
