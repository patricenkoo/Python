...
#space.
#
#The file will always contain 52 lines. The first 26 lines
...
#Add your code here!
with open("heronames.txt", 'r') as looking:
    names_List = looking.read().splitlines()

def generate_name(filename, indiv_name):
    names = indiv_name.split()
    char1 = names[0][0]
    char2 = names[1][0]
    return str(names_List[ord(char1) - 65])+" "+ str(names_List[ord(char2) - 91])
